...
export const useStoreWallet = create<WalletState>()(set => ({
    ...
    setMyStarknetWalletObject: (wallet: WalletWithStarknetFeatures | undefined) => { set({ StarknetWalletObject: wallet }) },
    address: "",
    setAddressAccount: (address: string) => { set(state => ({ address })) },
    chain: "",
    setChain: (chain: string) => { set(state => ({ chain: chain })) },
    myWalletAccount: undefined,
    setMyWalletAccount: (myWAccount: WalletAccountV6 | undefined) => { set({ myWalletAccount: myWAccount }) },
    account: undefined,
